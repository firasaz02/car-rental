            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($bookings as $booking)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900">{{ $booking->vehicle->vehicle_number }}</div>
                            <div class="text-sm text-gray-500">{{ $booking->vehicle->driver_name }}</div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <span class="text-gray-400">ID: {{ $booking->id }}</span>
                            </div>
                        </td>
                    </tr>
                @empty
