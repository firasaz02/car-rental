    ...
    <div class="modern-card p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600">Update vehicle information and assignments</p>
            </div>
        ...
        <div class="modern-card p-6">
            ...
            <div>
                ...
                @error('chauffeur_id')
                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                @enderror
                <p class="mt-2 text-sm text-gray-500">Select a chauffeur to assign to this vehicle</p>
            </div>
        </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-6">
                        ...
                        <div class="flex-1">
                            <p class="text-sm text-gray-600">Current vehicle image</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="url" 
                           name="image_url" 
                           id="image_url" 
                           value="{{ old('image_url', $vehicle->image_url) }}"
...
document.getElementById('image_url').addEventListener('input', function() {
    ...
    const img = document.querySelector('img[alt="{{ $vehicle->vehicle_number }}"]');
